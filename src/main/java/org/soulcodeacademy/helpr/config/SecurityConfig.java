...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers(PUBLIC_ENDPOINTS).permitAll() //possibilita os endspoints no array serem PUBLICOS
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        // configuration.addAllowedOrigin("http://localhost:4200"); delimita a origem das requisições.
